...
def decode_configs(org_code):
    headers = {
        ...
        "Cookie": "UM_distinctid=1763fe86843a97-05d8b9e6614128-c791930-144000-1763fe86844c03; NTKF_T2D_CLIENTID=guest1E582CC6-D4B4-A70F-454A-40C05E33683E; retailer=%7B%22id%22%3A58%2C%22code%22%3A%22ygyj%22%2C%22name%22%3A%22%E9%98%B3%E5%85%89%E7%9B%8A%E4%BD%B3%22%2C%22businesses%22%3A%5B%22payin%22%2C%22consign%22%5D%7D; joowing-session-id=ddc7a5c24c18def09bfd567e885cab45; login=chong.chen; joowing-staff-jwt=eyJhbGciOiJIUzI1NiJ9.eyJuYW1lIjoiY2hvbmcuY2hlbiIsImVtYWlsIjoiY2hvbmcuY2hlbkBqb293aW5nLmNvbSIsInR5cGUiOiJqb293aW5nLXN0YWZmIiwiZXhwIjoxNjA3NTM3NzY5fQ.Hnoig3Y_m2oHyO9TS20HgKXWBqYhhkZBFjhlomGHnN0",
...
def write_xmlfile(connect_path, decode_config, org_code):
    ...
    with open(connect_path, 'a+') as file:
        if ConnType == 'sql_server':
            ...
            file.write('\n')
            print('{"name": "%s", "type": "CONNECTION", "server_type": "MSSQL"}'%ConnectionName)
        elif ConnType == 'mysql':
            ...
            file.write(write_text)
            file.write('\n')
            print('{"name": "%s", "type": "CONNECTION", "server_type": "MYSQL"}'%ConnectionName)
    return 0
